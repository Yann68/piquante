...
// vérification si l'utilisateur est déja inscrit avec la fonction findOne() en regardant l'email dans le corps body 
// si l'utilisateur existe pas dans la base de donnéé on retour une reponse d'erreur
...
// si le MDP correspond avec la base de donnée 
